...
const navigation = [
    ...
    { name: 'Algo Aquí', href: '#', current: false },
    { name: 'LinkedIn', href: 'www.linkedin.com/in/marco845062237', current: false },
]
...
export default function NavbarTailwind() {
    return (
        <Disclosure as="nav" className="bg-sky-900 lg:z-50 lg:border-b lg:border-white/30">
        {({ open }) => (
            <>
